...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    	...
    	<form action="delete.php" method="post" class="form-inline my-2 my-lg-0">
			<input class="form-control mr-sm-2" type="search" placeholder="Delete by CODE" name="id1" aria-label="Search">
      		<button action="delete.php" name="delete" class="nav-link btn btn-outline-danger" >Delete Record</button>  
    	</form>
	</div>
</nav>
       ...
       ?>
       	<tr>
       		...
       		<td><?php echo $rows['end_date']; ?></td>
				...
				<a href="view.php" class="btn btn-outline-info" target="_blank">View</a>
				<a href="update.php" class ="btn btn-outline-warning" target="_blank">Update</a>				
			  </td>
       	</tr>	
       	<?php	
    		}
